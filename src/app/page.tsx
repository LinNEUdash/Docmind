    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center space-y-8 px-6">
        ...
        <button
          ...
          className="inline-flex items-center gap-3 px-8 py-3.5 bg-white text-slate-800 rounded-xl hover:bg-slate-100 transition-all font-medium shadow-lg shadow-black/20 hover:shadow-xl hover:shadow-black/30 hover:-translate-y-0.5"
        >
        ...
        <p className="text-slate-600 text-sm">
          Powered by AI to help you understand your documents
        </p>
      </div>
    </div>
  );
